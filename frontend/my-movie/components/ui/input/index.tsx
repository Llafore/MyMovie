...
const inputStyle = tva({
  base: 'border-secondary-light flex-row overflow-hidden rounded-lg content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary data-[focus=true]:hover:border-primary data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-neutral-500 items-center',
...
const inputFieldStyle = tva({
  base: 'w-full p-4 text-white placeholder:text-neutral-500 h-auto ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
